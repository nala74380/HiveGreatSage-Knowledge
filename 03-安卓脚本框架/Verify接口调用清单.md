...
关联文档:
  ...
  - "[[03-安卓脚本框架/热更新方案]]"
变更记录:
  - V1.0.1 (2026-05-12): 目录级治理；修正裸链和过时规范链接；补充 AndroidScript Verify 调用清单证据边界；清理示例账号密码和真实样式 project_uuid
...
3. 未对登录限流 429 做专门提示。
4. 未对服务器地址错误做明确提示。
5. 文档中禁止记录真实用户名、真实密码、真实 Token、真实 Refresh Token、生产 project_uuid、OCR / YOLO 授权码或完整 IMSI。
```
